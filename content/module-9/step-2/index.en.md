...
- Select **StepFunctionsWorkshop** from the environment list and click **Open IDE** button. Customize the display by closing the **welcome tab** and the **lower work area**. Open a new **terminal** tab in the main work area:
