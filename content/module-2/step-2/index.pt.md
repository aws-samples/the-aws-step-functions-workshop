...
- Na página _Especificar detalhes da pilha_, o nome da pilha será preenchido automaticamente para `SFW-Module-2`. Você pode especificar um nome diferente, se desejar.
