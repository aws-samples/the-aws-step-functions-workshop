...
- Na página _Especificar detalhes da pilha_, o nome da pilha seria preenchido automaticamente para `SFW-Module-5`. Você pode especificar um nome diferente, se desejar.
